...
export function AppShell({ sidebar, toolbar, inspector, statusBar, children }: AppShellProps) {
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden bg-surface font-sans text-slate-100 antialiased">
